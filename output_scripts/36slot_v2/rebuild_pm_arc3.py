# -*- coding: utf-8 -*-
"""扇区 PM v3: 与成功的槽 polyline 相同结构（Arc 段带中间点，显式闭合）"""
...
def make_pm(name, mat, color):
    # 用 5 个点: 外弧起/中外弧/外弧终/内弧终/内弧起, 闭合回外弧起
    a0 = math.radians(-half_arc)
    a1 = math.radians(0.0)
    a2 = math.radians(half_arc)
    ...
    p4 = (r_in*math.cos(a0), r_in*math.sin(a0))
